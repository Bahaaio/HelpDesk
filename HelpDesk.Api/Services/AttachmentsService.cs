    ...
    IAuthorizationService authorizationService)
{
        ...
        ClaimsPrincipal user)
    {
        ...
        await storageService.Store(file, guid.ToString());
    ...
    public async Task DeleteAttachment(Guid attachmentId, ClaimsPrincipal user)
    {
        ...
        await storageService.DeleteFile(attachmentId.ToString());
    ...
    {
        var stream = await storageService.Load(attachmentId.ToString());
